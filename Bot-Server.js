...
//end data control
 ...
 console.log("ai message identified")
    ...
    if (message.content === "<:patUrn:898515113106083850>"){
        Data.Urnpats = ++Data.Urnpats
        Write(Data)
            client.channels.fetch(message.channelId).then(channel => channel.send(`Urn has been pet ${Data.Urnpats} times!`))
    }
